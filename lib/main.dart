...
import 'package:todo_app_lesson_10_1/widgets/counter.dart';
import 'package:todo_app_lesson_10_1/widgets/todo_card.dart';
  ...
  addTask() {
    setState(() {
      ...
      if (myText?.isNotEmpty ?? true) {
        myActs.add(Task(title: myText!, isDone: true));
        myController.clear();
      }
    });
